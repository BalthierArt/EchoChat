...
public static class ChannelDefs
{
    ...
    public static readonly Def[] All =
    {
        ...
        new("npcdialog", "NPC Dialogue", new(0.93f, 0.86f, 0.62f, 1), new[] { XivChatType.NPCDialogue }),
        ...
        new("gainbuff",   "Gain Buff",   new(0.47f, 0.93f, 0.62f, 1), new[] { (XivChatType)46 },      HasSender: false),
        new("gaindebuff", "Gain Debuff", new(0.93f, 0.47f, 0.68f, 1), new[] { (XivChatType)47 },      HasSender: false),
        new("losebuff",   "Lose Buff",   new(0.68f, 0.78f, 0.93f, 1), new[] { (XivChatType)48 },      HasSender: false),
        new("losedebuff", "Lose Debuff", new(0.93f, 0.68f, 0.47f, 1), new[] { (XivChatType)49 },      HasSender: false),
    };
